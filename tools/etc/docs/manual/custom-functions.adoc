...
Functions in a `.jq` module have full access to jq{plus}{plus} builtins such as `ref`, `refexpr`, `reftag`, `parent`, and `topathexpr`.
...
A function can also resolve values from the surrounding jq{plus}{plus} document directly:

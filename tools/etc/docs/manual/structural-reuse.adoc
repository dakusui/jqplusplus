...
Structural reuse consists of *structural composition* (`$extends` and `$includes`), opt-in inherited-array composition (`$super` and `$super*`), and *expression evaluation* (`eval:`).
